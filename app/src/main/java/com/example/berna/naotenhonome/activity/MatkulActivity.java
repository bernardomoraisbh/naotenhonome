...
import com.example.berna.naotenhonome.adapter.MatkulAdapter;
import com.example.berna.naotenhonome.model.ResponseMatkul;
import com.example.berna.naotenhonome.model.SemuamatkulItem;
import com.example.berna.naotenhonome.util.Constant;
import com.example.berna.naotenhonome.util.RecyclerItemClickListener;
        ...
        mApiService.getSemuaMatkul().enqueue(new Callback<ResponseMatkul>() {
            ...
            public void onResponse(Call<ResponseMatkul> call, Response<ResponseMatkul> response) {
                if (response.isSuccessful()) {
                    ...
                    loading.dismiss();
                    Toast.makeText(mContext, "Falha ao recuperar dados do banco.", Toast.LENGTH_SHORT).show();
                }
            }
